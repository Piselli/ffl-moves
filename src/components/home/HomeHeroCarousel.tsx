...
/** WC is slide 0 (primary), APL is slide 1 — WC only on localhost until public flag. */
const WC_INDEX = 0;
const APL_INDEX = 1;
...
export function HomeHeroCarousel({
  ...
  const slideCount = wcSurface ? 2 : 1;
  const initialIndex = wcSurface ? WC_INDEX : APL_INDEX;
