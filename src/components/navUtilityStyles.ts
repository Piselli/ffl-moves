...
export const NAV_TRAY_BTN =
  "box-border inline-flex h-9 shrink-0 items-center justify-center whitespace-nowrap rounded-xl px-3 font-display text-[11px] font-black uppercase leading-none tracking-wide transition-[filter,box-shadow,transform] duration-150 ease-[cubic-bezier(0.23,1,0.32,1)] hover:brightness-[1.04] active:scale-[0.97] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#00f948]/40 focus-visible:ring-offset-1 focus-visible:ring-offset-black/80";

/** Deposit — soft convex green (want-to-click, not neon). */
