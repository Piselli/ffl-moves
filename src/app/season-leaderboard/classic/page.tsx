...
export default function SeasonLeaderboardPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 pt-28 pb-12">
      <div className="mb-6 flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-white/[0.08] bg-white/[0.03] px-4 py-3">
        <p className="text-xs text-white/45">
          Classic table view. Prefer the ladder wall?
        </p>
        <Link
          href="/season-leaderboard"
          className="text-[11px] font-bold uppercase tracking-wider text-[#00f948] hover:text-[#00f948]/80"
        >
          Open ladder wall →
        </Link>
      </div>
