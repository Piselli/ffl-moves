...
- [x] Зафіксовано відповідність «тур → актив» (MOVE чи USDCx) — `archive/movement-snapshot/2026-07-31/TOUR-ASSETS.md`
- [x] Вирішено долю 11 невитребуваних призів — без дедлайну, claim лишається відкритим (HANDOFF 2026-08-01)
- [ ] Вирішено долю bracket-челенджу (18 прогнозів, не резолвлений) — **фаза 6**, до sunset-оголошення
- [ ] Solana-версія відпрацювала повний тур на mainnet (реєстрація → сеттл → claim) — **фаза 6**
- [ ] Гравцям повідомлено про перехід і про долю невитребуваних призів — **фаза 6**, перед mainnet або на старті claims-only
