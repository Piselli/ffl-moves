...
- [ ] Зафіксовано відповідність «тур → актив» (MOVE чи USDCx) поруч зі знімком
- [ ] Вирішено долю 11 невитребуваних призів
- [ ] Вирішено долю bracket-челенджу (18 прогнозів, не резолвлений)
- [ ] Solana-версія відпрацювала повний тур на mainnet (реєстрація → сеттл → claim)
- [ ] Гравцям повідомлено про перехід і про долю невитребуваних призів
- [ ] Невитребувані призи на Movement або виплачені, або має бути описана політика
