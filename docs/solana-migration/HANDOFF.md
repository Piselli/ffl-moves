...
- Адреса Squads-мультисигу (потрібна до перезбірки програми).
- Доля bracket 10999: резолвити, скасувати чи перенести.
- Повний тур на mainnet.
- Чи зараховувати Movement-історію в season points, і чи будувати flow
  «доведи контроль над старим гаманцем» — без нього звʼязку адрес немає.
